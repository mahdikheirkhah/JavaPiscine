...
public class Circle implements Drawable {
    ...
    public Circle(Point center, int radius) {
        ...
        this.color = new Color(rand.nextInt(256), rand.nextInt(256), rand.nextInt(256)); // Random color for circles
    }
    ...
    public void draw(Displayable displayable) {
        ...
        while (x >= y) {
            plotCirclePoints(displayable, x0, y0, x, y);
            y++;
    ...
    private void plotCirclePoints(Displayable displayable, int x0, int y0, int x, int y) {
